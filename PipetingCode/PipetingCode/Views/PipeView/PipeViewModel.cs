namespace PipettingCode.Views
{
    ...
    //    {
    //        MainSingletonService.Instance.Log.Info(msg);
    //    }
    //    #region 0 连接网络
    //    #region 0.1 断开网络
    ...
    //            mCommData.mIPAddress = Global_Parameter.IPAddress;                   // 1.加样臂网卡IP地址
    //            mCommData.mIPport = Global_Parameter.IPPort;                      // 2.加样臂网卡使用的端口
    //            mCommData.mSamplesize = TxtNumberOfStitches;          // 3.通道数量，根据实际实验使用几根针
    ...
    //        //    mCommData.mSamplesize = TxtNumberOfStitches;    // 通道数量，也就是样本数量
    ...
    //        //    for (int i = 0; i < TxtNumberOfStitches; ++i)
    //        //    {
    ...
    //        //                    PLCViewModel.GetInstance().PLC_SendCommand_Write("Y19", 1);
    //        //                    ExperimentErrorViewModel.GetInstance().ErrorContext = msg;
    //        //                    new ExperimentError().ShowDialog();
    //        //                    ExperimentErrorViewModel experimentErrorViewModel = ExperimentErrorViewModel.GetInstance();
    //        //                    switch (experimentErrorViewModel.ErrorSingle)
    //        //                    {
    //        //                        case ExperimentErrorViewModel.ErrorCode.ReTry:
    ...
    //        //    {
    //        //        mParameter.mSuctionHeight = TxtImmersionDepth10;            //6.吸液高度
    //        //    }
    //        //    else if (ShiGuanViewModel.GetInstance().SelectedType == "20混")
    //        //    {
    //        //        mParameter.mSuctionHeight = TxtImmersionDepth20;            //6.吸液高度
    //        //    }
    //        //    mParameter.mTipGap = TxtTipClearance;              //7.30针尖空气间隙(μl):
    //        //    mParameter.mNeedleTailGap = TxtNeedleTailGap;             //8.50//针尾空气间隙(μl)
    //        //    mParameter.mSuctionSpeed = MtxtVolumeSpeed;              //9.1000//吸液速度(μl/s):
    //        //    mParameter.mSuctionAccSpeed = MtxtVolumeAccSpeed;           //10.700//吸液加速度(μl/s^2):
    //        //    mParameter.mImmersionDepth = MtxtImmersionDepth;           //11.20//浸没深度(步):
    //        //    mParameter.mLiquidabsorption = TxtSuctionVolume;             //12.吸液量
    //        //    mParameter.mRegurgitationvolume = TxtRegurgitation;             //13.回吐量
    //        //    mParameter.mRetrusionHeight = TxtRetrusionHeight;           //14.回吐高度
    //        //    mParameter.mHeightLimited = MtxtHeightLimited;            //15.液面探测的限制高度

    //        //    // 单混液面探测高度
    //        //    if (ShiGuanViewModel.GetInstance().SelectedType == "单混")
    //        //    {
    //        //        mParameter.mLiquidLevelDetectionHeight = LiquildDectectionHeight01;                     //16.液面探测高度
    //        //    }
    //        //    else           // 10混、20混液面探测高度
    //        //    {
    //        //        mParameter.mLiquidLevelDetectionHeight = LiquildDectectionHeight10;                     //16.液面探测高度
    //        //    }

    //        //    mParameter.mLiquidLevelDetectionSpeed = TextBox3;                     //17.液面探测速度
    //        //    mParameter.mSuctionDelay = TxtDelay;                     //18.吸液延时
    //        //    mParameter.mAmountOfSuction = TxtDesorptionL;                        // 19.回吸量

    //        //    mCommData.mEnableFlag[0] = 1;          // 1针
    //        //    mCommData.mEnableFlag[1] = 1;          // 2针
    //        //    mCommData.mEnableFlag[2] = 1;          // 3针
    //        //    mCommData.mEnableFlag[3] = 1;          // 4针
    ...
    //        //    {
    //        //        // 差值不满足要求
    //        //        if (Math.Abs(diff[i]) < this.Threshold + ThresholdPress[i])
    //        //        {
    //        //            int index = (count / 2 * 2) * 4 + count % 2 + (i % 4) * 2;
    //        //            if (CheckViewModel.GetInstance().SelectedItems.Contains(index))
    //        //            {
    ...
    //        //                new ImbibitionErrorWindow().ShowDialog();
    //        //                ExperimentErrorViewModel experimentErrorViewModel = ExperimentErrorViewModel.GetInstance();
    //        //                switch (experimentErrorViewModel.ErrorSingle)
    //        //                {
    //        //                    case ExperimentErrorViewModel.ErrorCode.ReTry:
    ...
    //        //            for (int i = 0; i < TxtNumberOfStitches; ++i)
    //        //            {
    //        //                if (Math.Abs(diff[i]) < this.Threshold + ThresholdPress[i] && !HasLiquild.Contains(i))
    //        //                {
    ...
    //        //    mCommData.mIPAddress = Global_Parameter.IPAddress;                   // 1.加样臂网卡IP地址
    //        //    mCommData.mIPport = Global_Parameter.IPPort;                      // 2.加样臂网卡使用的端口
    //        //    mCommData.mSamplesize = TxtNumberOfStitches;
    ...
    //        int[] diff = new int[TxtNumberOfStitches];
    ...
    //    public int _txtNumberOfStitches;
    //    public int TxtNumberOfStitches
    //    {
    //        get => _txtNumberOfStitches;
    //        set => SetField(ref _txtNumberOfStitches, value);
    //    }
